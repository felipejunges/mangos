...
namespace Mangos.Mvc.Controllers
{
    ...
    public class ReceitaController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lancamentos = await _lancamentoRepository.ListarLancamentosAsync(_userResolverService.GrupoId, TipoLancamento.Receita, string.Empty, tipoPesquisa, string.Empty, dataInicial, dataFinal, tipoData);
        ...
        public async Task<IActionResult> IndexLista(string tipoBusca, string descricao, string tipoPesquisa, string pesquisa, string mes, DateTime? dataInicial, DateTime? dataFinal, LancamentoTipoDataPesquisa tipoData)
        {
            ...
            var lancamentos = await _lancamentoRepository.ListarLancamentosAsync(_userResolverService.GrupoId, TipoLancamento.Receita, descricao, tipoPesquisa, pesquisa, dataInicial!.Value, dataFinal!.Value, tipoData);
        ...
        public async Task<IActionResult> Agrupadas(Guid agrupador)
        {
            ...
            var lancamentos = await _lancamentoRepository.ListarLancamentosPeloAgrupadorAsync(_userResolverService.GrupoId, TipoLancamento.Receita, agrupador);
        ...
        public async Task<IActionResult> Incluir()
        {
            var lancamentoInclusaoModel = new LancamentoInclusaoModel(
                ...
                categorias: CategoriaMappers.ToListaModel(await _categoriaRepository.ListarCategoriasAsync(_userResolverService.GrupoId, string.Empty, TipoCategoriaPesquisa.Receita, false)),
        ...
        public async Task<IActionResult> Incluir(LancamentoInclusaoModel lancamentoInclusaoModel)
        {
            if (ModelState.IsValid)
            {
                ...
                var command = LancamentoMappers.ToIncluirCommand(lancamentoInclusaoModel, TipoLancamento.Receita);
            ...
            lancamentoInclusaoModel.AtualizarCategoriasCartoesCredito(
                categorias: CategoriaMappers.ToListaModel(await _categoriaRepository.ListarCategoriasAsync(_userResolverService.GrupoId, string.Empty, TipoCategoriaPesquisa.Receita, false, lancamentoInclusaoModel.CategoriaId)),
        ...
        public async Task<IActionResult> IncluirPaga(LancamentoPagoInclusaoModel lancamentoInclusaoModel)
        {
            if (ModelState.IsValid)
            {
                ...
                var command = LancamentoMappers.ToIncluirPagoCommand(lancamentoInclusaoModel, TipoLancamento.Receita);
        ...
        public async Task<IActionResult> Excluir(int id)
        {
            ...
            try
            {
                ...
                return SucessoResult("Receita excluída com sucesso.");
            }
            catch
            {
                return ErroResult("Erro ao excluir receita.");
            }
        }

        public async Task<IEnumerable<CategoriaListaModel>> ObterCategoriasModel(int? categoriaSuperiorId = null)
        {
            // Esse método, quando esses models forem migrados, irá pra dentro do ModelBuilder
            var categorias = await _categoriaRepository.ListarCategoriasAsync(_userResolverService.GrupoId, string.Empty, "R", false, categoriaSuperiorId);
